...
func (env *DockerEnv) CreateContainer(langID int, apiPort string) (string, error) {

	n := make(map[int]Language)
	n[1] = Language{LangID: 1, Name: "python", Image: "python-build"}
	n[2] = Language{LangID: 2, Name: "go", Image: "go-build"}
	n[3] = Language{LangID: 3, Name: "node", Image: "node-build"}
